...
namespace API.Controllers
{
    ...
    public class LikesController : BaseApiController
    {
        ...
        {
            var sourceUserId = User.GetUserId(); // Get from the token information
            var likedUser = await _unitOfWork.UserRepository.GetUserByUsernameAsync(username); // return user
